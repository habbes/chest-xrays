"""
Concrete Dropout custom layers (keras)
The source code in this script is based on IPYTHON notebooks 
published by Yarin Gal at:
https://github.com/yaringal/ConcreteDropout/blob/master/spatial-concrete-dropout-keras.ipynb

The idea is described in the NIPS 2017 paper: 
https://papers.nips.cc/paper/6949-concrete-dropout.pdf
Yarin Gal, Jiri Hiron, Alex Kendall. 
"""
import keras
